...
<body style="background-image: linear-gradient(to right, rgba(255,0,0,0), rgb(87, 137, 194))">
    <div class="topSection">
        ...
        <a href="aboutUs.php" class='aboutPbl'>About Project Shop</a>
        <h4 class='devider'>|</h4>
    ...
    <div class='navbar'>
        <div class='navCont'>
            ...
            <a href="merchantall.php" id="nav-cont">Security</a>
        </div>
    </div>
    <div class="merchantForm">
            <h2 style="padding-top: 200px">Shop Employee Info Update</h2>
