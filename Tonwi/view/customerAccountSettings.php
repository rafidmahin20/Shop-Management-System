...
<html>
<head>
    <title>SHOP: Customer Info Update</title>
...
if ($userQuery->num_rows > 0) {
    ...
    <div class='navbar'>
        ...
        <a href="customerDashboard.php" id="nav-cont">Dashboard</a>
            ...
            <a href="cusDeposite.php" id="nav-cont">conditions</a>
            <a href="cusWithdraw.php" id="nav-cont">goods</a>
            <a href="cusLoan.php" id="nav-cont">service</a>
            <a href="customerAccountSettings.php" id="nav-cont">Account Settings</a> </div>
        </div>
     </div>
    
    <div class="customerForm">
            <h2>Customer Info Update</h2>   
