...
<body>
    <div class="topSection">
        ...
        <h1 class='topTitle'>Shop Management System</h1>
    ...
    <div class='navbar'>
        <div class='nav-main'>
            ...
            <a href="terms.php" id="nav-cont">s</a>
            <a href="loan.php" id="nav-cont">s</a>
            <a href="branches.php" id="nav-cont">s</a>
        </div>
    </div>
    <div class="reg">
        <h1 id="signup-top">Welcome to SHOP</h1>
